...
namespace DataAccessLayer.Implementation
{
    public class BaseRepo<T> : IBaseRepo<T> where T : class
    {
        ...
        public async Task<List<T>> GetAllAsync(Expression<Func<T, bool>>? predicate = null, Expression<Func<T, object>>[]? includes = null)
        {
            IQueryable<T> query = _dbSet.AsQueryable();
        ...
        public bool IsEnityExist(Expression<Func<T, bool>>? predicate)
        {
